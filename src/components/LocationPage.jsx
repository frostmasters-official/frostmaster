...
const LocationPage = ({ data, city, area }) => {
  ...
  return (
    <div className="min-h-screen selection:bg-[#B6F500] font-general">
      {/* Hero Section */}
      <section className="relative items-center justify-center pt-32 pb-20 px-4 md:px-10 lg:px-20 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center max-w-4xl">
          ...
          >
            <span className="text-[#111B34] font-bold tracking-widest uppercase text-sm md:text-base mb-4 block">
              {city} &bull; {area.replace("-", " ")}
            </span>
            <h1 className="text-[#111B34] text-4xl md:text-6xl font-extrabold leading-tight mb-6">
              {data.h1}
            </h1>
            <p className="text-[#111B34] text-lg md:text-xl leading-relaxed mb-8 text-justify">
              {data.metaDescription}
            </p>
            <a
              href={`tel:${getPhoneForCity(city).tel}`}
              className="inline-flex items-center gap-2 bg-[#B6F500] text-black px-8 py-4 rounded-full text-xl font-bold hover:scale-105 transition-transform duration-300"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
              <h2 className="text-3xl font-bold mb-6 text-[#111B34]">
                About Our Service
              </h2>
              <p className="text-[#111B34] text-lg leading-relaxed whitespace-pre-wrap text-justify">
                {data.content.intro}
              </p>
            </div>
            ...
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
              <div className="flex items-center gap-4 mb-6">
                <MapPin className="w-8 h-8 text-[#B6F500]" />
                <h2 className="text-3xl font-bold">
                  Serving {area.replace(/-/g, " ")}
                </h2>
              </div>
              <p className="text-[#111B34] text-lg leading-relaxed text-justify">
                ...
                {data.content.benefits.map((benefit, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="p-6 rounded-xl bg-gradient-to-br from-white/10 to-transparent border border-white/5 hover:border-[#B6F500]/50 transition-colors"
                    >
                      <CheckCircle className="w-8 h-8 text-[#B6F500] mb-4" />
                      <h3 className="text-xl font-bold mb-2">{title}</h3>
                      <p className="text-[#111B34] text-justify">{desc}</p>
                    </motion.div>
                  );
                })}
              </div>
          ...
          <div className="lg:col-span-1 space-y-8">
            {/* Services List */}
            <div className="bg-[#B6F500] text-black p-8 rounded-2xl">
            ...
            <div className="bg-white/10 p-8 rounded-2xl border border-white/10">
              ...
              <div className="space-y-4">
                ...
                <Link
                  href="/contact"
                  className="flex items-center justify-center gap-3 w-full border border-[#111B34] text-[#111B34] py-3 rounded-lg font-bold hover:bg-[#B6F500]/10 transition"
                >
            ...
            {/* Trust Signals */}
            <div className="p-8 rounded-2xl bg-[#111B34]/10 border border-[#111B34]/20">
              <ShieldCheck className="w-12 h-12 text-[#B6F500] mb-4" />
              <h3 className="text-xl font-bold mb-2">Verified Professionals</h3>
              <p className="text-[#111B34] italic text-justify">
      ...
      <section className="py-12 px-4 md:px-10 border-t border-[#111B34]/20 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl font-bold text-[#111B34] mb-2 text-center">
            Appliance repair searches in {areaName}
          </h2>
          <p className="text-[#111B34]/80 text-center mb-6 text-sm md:text-base">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {data.keywords?.map((kw, idx) => (
              <span
                key={idx}
                className="text-xs md:text-sm text-[#111B34] bg-white border border-[#111B34]/10 px-3 py-1.5 rounded-full shadow-sm hover:border-[#B6F500]/50 transition-colors"
              >
                {kw}
              </span>
            ))}
          </div>
          <div className="mt-10 pt-8 border-t border-[#111B34]/10">
            <h3 className="text-lg font-semibold text-[#111B34] mb-4">
              Why search for appliance repair in {areaName}, {cityName}?
            </h3>
            <p className="text-[#111B34] text-justify leading-relaxed">
