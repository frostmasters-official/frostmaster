    ...
    <>
      <section id="about" className="relative overflow-hidden py-20">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(238,63,74,0.03) 0%, transparent 70%)",
          }}
        />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 auto-rows-[minmax(180px,auto)] gap-4 lg:gap-6 mt-12">
            ...
            >
              <div className="relative z-10">
                ...
                >
                  ...
                  <span className="text-blue-500">Appliance Excellence</span>
                </h3>
                <p
                  className="text-black leading-relaxed max-w-lg"
                  style={{ fontFamily: "'Inter',sans-serif", fontSize: "1rem" }}
                >
                  At Frost Masters, we've redefined appliance repair for the
                  modern home. No more waiting days for a fix—we bring
                  precision, genuine parts, and expert care to your doorstep
                  within the hour.
                </p>
              </div>
              ...
              {/* Decorative Accent */}
              <div className="absolute top-0 right-0 w-80 h-80 bg-blue-500/10 rounded-full blur-[100px] -mr-32 -mt-32 pointer-events-none" />
            </motion.div>
              ...
              <div className="grid grid-cols-2 gap-8">
                {stats.slice(0, 2).map((stat, i) => (
                  <div key={i} className="flex flex-col gap-2">
                    ...
                    <span className="text-[11px] uppercase tracking-[0.2em] text-black/40 font-bold">
                      {stat.label}
                    </span>
                  </div>
                ))}
            ...
            >
              <div className="flex flex-col gap-2 relative z-10">
                ...
                <span className="text-xs uppercase tracking-widest text-black/40 font-bold">
                  Trusted by 5,000+ Kochi Homes
                </span>
              </div>
              <div className="w-16 h-16 rounded-2xl bg-blue-500/5 flex items-center justify-center border border-blue-500/10 group-hover:bg-blue-500 group-hover:border-blue-500 transition-all duration-500 relative z-10">
                <Users className="w-8 h-8 text-blue-500 group-hover:text-white transition-colors duration-500" />
              </div>
              {/* Subtle background flair */}
              <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-blue-500/5 rounded-full blur-2xl group-hover:bg-blue-500/10 transition-colors duration-500" />
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-10 left-10 right-10">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-white/80 text-[11px] font-bold uppercase tracking-[0.3em]">
                    Currently Active in Ernakulam
                  </span>
                </div>
                <h4
                ...
                >
                  ...
                  <span className="text-blue-500">Expertly Trained</span> for
                  Every Brand
                </h4>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between">
                <h4
                  className="text-black font-black uppercase tracking-[0.2em] text-xs"
                  style={{ fontFamily: "'Montserrat',sans-serif" }}
                >
                  Our Standard
                </h4>
              ...
              <div className="space-y-6">
                {features.map((f, i) => (
                  <div key={i} className="flex items-start gap-5 group">
                    <div className="w-10 h-10 rounded-xl bg-black/5 flex items-center justify-center shrink-0 transition-colors">
                      <CheckCircle className="w-5 h-5 text--blue-500" />
                    </div>
                    <div>
                      <p className="group-hover:text-blue-500 transition-colors duration-500 text-base font-bold text-black leading-tight mb-1">
                        {f}
                      </p>
                      <p className="text-xs text-black/40 font-medium">
                        Guaranteed excellence in every service call.
                      </p>
                    </div>
                  </div>
                ))}
            ...
            <motion.div
              className="lg:col-span-5 lg:row-span-1 rounded-[2.5rem] p-8 border border-blue-500/10 bg-white shadow-sm flex items-center gap-6 group hover:bg-blue-500 transition-all duration-500"
              {...fadeUp(0.6)}
            >
              <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500">
                <ShieldCheck className="w-8 h-8 text-blue-500" />
              </div>
              <div className="flex flex-col gap-1">
                <span
                  className="text-2xl font-black text-black group-hover:text-white transition-colors"
                  style={{ fontFamily: "'Montserrat',sans-serif" }}
                >
                  30-Day Warranty
                </span>
                <span className="text-xs font-bold text-blue-500 group-hover:text-white uppercase tracking-widest transition-colors">
