...
import { FileText, Mail, Phone, MapPin, Globe, ChevronRight, HandCoins, AlertTriangle, RotateCcw, UserCheck, RefreshCw } from "lucide-react";
  ...
  const sections = [
    {
      ...
      content: (
        <p>
          We provide repair and maintenance services for home appliances such as washing machines, refrigerators, air conditioners, dishwashers, and microwave oven. Service availability may vary based on location.
        </p>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            All service bookings must be made through our website or customer support. 
            Service charges will be communicated before work begins.
          </p>
      ...
      content: (
        <ul className="space-y-3">
          <li className="flex gap-3">
            ...
            <span>Customers must provide accurate information while booking services.</span>
          </li>
          <li className="flex gap-3">
            <ChevronRight className="w-5 h-5 text-[#EE3F4A] flex-shrink-0 mt-0.5" />
            <span>Ensure safe access to the appliance at the scheduled time.</span>
          </li>
        </ul>
      ),
    },
    ...
    <main className="bg-white min-h-screen text-gray-900 font-body">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 text-center">
          <motion.div {...fadeUp(0)}>
            <div className="flex items-center justify-center gap-2 mb-4">
              <FileText className="w-5 h-5 text-[#EE3F4A]" />
              <span className="text-[#EE3F4A] uppercase tracking-[0.3em] font-bold text-[0.65rem]">Service Agreement</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 font-heading">
              Terms & <span className="text-[#EE3F4A]">Conditions</span>
            </h1>
      ...
      <section className="py-20 bg-gray-50 mb-10 mx-6 rounded-[2rem] lg:rounded-[3rem]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div {...fadeUp(0)}>
            <h2 className="text-3xl font-black mb-10 font-heading">Need <span className="text-[#EE3F4A]">Support?</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              ...
              <div className="flex items-start gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 transition-transform hover:-translate-y-1 h-full">
                ...
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">Head Office</p>
